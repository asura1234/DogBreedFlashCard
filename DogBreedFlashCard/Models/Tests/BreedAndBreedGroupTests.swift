...
struct BreedAndBreedGroupTests {
    ...
    func testBreedGroupInitialization() {
        ...
        #expect(breedGroup2.names.contains("Curly Retriever"), "Breed group should contain Curly Retriever")
        #expect(breedGroup2.names.contains("Flatcoated Retriever"), "Breed group should contain Flatcoated Retriever")
        #expect(breedGroup2.names.contains("Golden Retriever"), "Breed group should contain Golden Retriever")
    }
}
